...
在本波刷出至少 400cs 并且倒计时减少至 200 前, 若本波僵尸总血量不大于刷新激活血量, 则刷新倒计时被设置为 200, 即激活刷新 200cs 后刷出下一波. (两波僵尸的刷新间隔不小于 601cs.)
...
NE 无冰车, 关底前五列冒出墓碑, 墓碑冒出一只普僵/路障/铁桶. 场上最多 12 块墓碑, 墓碑未满且前场没空位则顶掉植物(玉米炮顶掉前轮不受影响, 即"压碑").
...
**以下部分脚本后期有更新, 可能会出现代码操作和视频内容不一致的情况.**
