...
---
Name: FE花环十六炮
Rhythm: C8u-50s: I-PPDD|I-PPDD|PPA'dd|PPDD|NAd|PPDD, (13|13|6|6|6|6)
Video:
- https://www.bilibili.com/video/av38409700
- https://youtu.be/La31spQ_bzU
"""
...
Until(1300 - 200 - 373)
Pao((2, 9), (5, 9))
Until(1300 + 60 - 100 - 320)  # 940
Card("模仿者寒冰菇", (1, 1))  # 60cs
...
Until(1300 - 200 - 373)
Pao((2, 9), (5, 9))
# Until(1300 + 60 - 100 - 320)  # 940  # 60cs
Until(1300 - 200 - 373 + 220)  # 947
Pao((1, 7.8), (5, 7.8))
Delay(250)
Pao((1, 1), (5, 1))  # 尾炸矿工
